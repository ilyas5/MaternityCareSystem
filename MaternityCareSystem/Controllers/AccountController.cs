...
namespace MaternityCareSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (rolesBL.UserIsLock(model.UserName)==false)
            {
                ViewBag.Message = "User is Locked";
                return View(model);
            }
            else
            { 
        ...
        public async Task<ActionResult> Register(RegisterViewModel model,string RoleId)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await this.UserManager.AddToRoleAsync(user.Id, RoleId);
                    return RedirectToAction("Index", "Roles",new { area="PN"});
                }
                AddErrors(result);
            }
